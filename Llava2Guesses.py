...
def get_emotion(image_path, corresponding_text, same_character):
    try:
        ...
        prompt = (
            ...
            "Your task is to take the image and text information, and label it your best guess of what emotion it is displaying.\n"
            "For your guess, choose between the following seven emotions:\n "
            "Happiness, Anger, Sadness, Fear, Disgust, Surprise, or Contempt.\n"
            "Then, provide a second guess of what emotion is being displayed. Please answer in the format: [Emotion, Emotion].\n"
        ...
        # Extract only the response content by removing the prompt
        response_content = response.split("[/INST]")[-1].strip()
